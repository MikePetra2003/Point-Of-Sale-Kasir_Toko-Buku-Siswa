...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'email.required' => 'Email masih kosong, harap dilengkapi!',
            'email.email' => 'Email yang Anda masukkan salah, silahkan cek kembali!',
            'password.required' => 'Password masih kosong, harap dilengkapi!',
        ];
    }

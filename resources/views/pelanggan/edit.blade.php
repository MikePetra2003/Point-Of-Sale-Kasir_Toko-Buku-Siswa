...
@section('title', 'Edit Pelanggan - POS Toko Buku')
...
<div class="form-card">
    <h3><i class="bi bi-pencil-square me-2"></i>Edit Pelanggan</h3>
    ...
    <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST">
        ...
        <div class="mb-3">
            <label class="form-label">No ID Pelanggan</label>
            <input type="text" class="form-control" value="{{ $pelanggan->no_id_pelanggan ?? '-' }}" readonly>
        </div>
